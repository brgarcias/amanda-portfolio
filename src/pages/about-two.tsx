...
import { jsTestimonials } from '@/utils/sliderProps';
...
import rev1 from '@/public/assets/images/rev1.png';
import rev2 from '@/public/assets/images/rev2.png';
import rev3 from '@/public/assets/images/rev3.png';
import rev4 from '@/public/assets/images/rev4.png';
  ...
  return (
    <Layout>
      <div className="wrapper">
        ...
        <div className="section hero-started bottom">
          <Image src={about2} alt="About 2" fill />
                ...
                <div className="team-items row">
                  <div className="team-col col-xs-12 col-sm-12 col-md-6 col-lg-4">
                    ...
                    >
                      <div className="image">
                        <div className="img">
                          <Image src={team5} alt="Team 5" fill />
                        </div>
                      </div>
                      <div className="desc">
                  ...
                  <div className="team-col col-xs-12 col-sm-12 col-md-6 col-lg-4">
                    ...
                    >
                      <div className="image">
                        <div className="img">
                          <Image src={team1} alt="Team 1" fill />
                        </div>
                      </div>
                      <div className="desc">
                  ...
                  <div className="team-col col-xs-12 col-sm-12 col-md-6 col-lg-4">
                    ...
                    >
                      <div className="image">
                        <div className="img">
                          <Image src={team2} alt="Team 2" fill />
                        </div>
                      </div>
                      <div className="desc">
              ...
              <div className="col-xs-12 col-sm-12 col-md-12 col-lg-9">
                ...
                >
                  ...
                  <SwiperSlide className="testimonials-item swiper-slide">
                    ...
                    >
                      <div className="image">
                        <Image src={rev1} alt="John Smith" fill />
                      </div>
                      <div className="desc">
                  ...
                  <SwiperSlide className="testimonials-item swiper-slide">
                    ...
                    >
                      <div className="image">
                        <Image src={rev3} alt="Natasha Singh" fill />
                      </div>
                      <div className="desc">
                  ...
                  <SwiperSlide className="testimonials-item swiper-slide">
                    ...
                    >
                      <div className="image">
                        <Image src={rev2} alt="Gray Woodman" fill />
                      </div>
                      <div className="desc">
                  ...
                  <SwiperSlide className="testimonials-item swiper-slide">
                    ...
                    >
                      <div className="image">
                        <Image src={rev4} alt="Robert Long" fill />
                      </div>
                      <div className="desc">
