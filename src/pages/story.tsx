...
const Story = () => {
  return (
    <Layouts
      ...
      rightPanelImg={'/assets/images/person/4.png'}
    >
      <PageBanner
            ...
            <div className="mil-timeline mil-mb-90">
              ...
              <ul>
                <li className="mil-up">
                  ...
                  <p>
                    Dolor sit amet, consectetur adipisicing elit laudantium ipsa
                    ad debitis unde? Iste voluptatibus minus.
                  </p>
                </li>
                <li className="mil-up">
                  <div className="mil-item-head mil-mb-5">
                ...
                <li className="mil-up">
                  ...
                  <p className="mil-text-sm mil-mb-15">Student</p>
                  <p>
                    Adipisicing elit iusto, optio, dolorum provident rerum aut
                    hic quasi placeat iure tempora laudantium ipsa ad debitis
              ...
              <ul>
                <li className="mil-up">
                  ...
                  <p>
                    Dolor sit amet, consectetur adipisicing elit. Iusto, optio,
                    dolorum provident rerum aut hic quasi placeat iure tempora
                    aste voluptatibus laudantium ipsa ad debitis unde. Iste
                ...
                <li className="mil-up">
                  ...
                  <p>
                    Dolor sit amet, consectetur adipisicing elit. Iusto, optio,
                    dolorum provident rerum aut hic tempora aste voluptatibus
                    laudantium ipsa ad debitis unde Iusto, optio, dolorum
                    provident rerum aut hic quasi placeat iure tempora.
                    Laudantium Iste voluptatibus minus veritatis qui ut. Rerum
                    aut hic quasi placeat iure tempora laudantium ipsa Iste
                    voluptatibus minus veritatis qui ut.
                  </p>
                </li>
                <li className="mil-up">
                  ...
                  <p>
                    ...
                    dolorum provident rerum aut hic quasi placeat iure tempora
                    laudantium ipsa ad debitis unde? Iste voluptatibus minus
                    veritatis qui ut. Dolor sit amet, consectetur adipisicing
                    elit.
                  </p>
                </li>
              </ul>
