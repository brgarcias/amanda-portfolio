...
import { mGalleryCarousel } from '@/utils/sliderProps';
import image1 from '@/public/assets/images/started-n12-920x1080.jpg';
import image2 from '@/public/assets/images/started-n15-920x1080.jpg';
import image3 from '@/public/assets/images/started-n2_4.jpg';
import image4 from '@/public/assets/images/started-n20.jpg';
import image5 from '@/public/assets/images/started-n14.jpg';
                ...
                <div className="works-item">
                  ...
                  >
                    <div className="img">
                      ...
                      >
                        <Image src={image1} alt="Image 01" fill />
                      </a>
                    </div>
                  </div>
                </div>
                  ...
                  >
                    <div className="img">
                      <a
                        ...
                        className="has-popup-image"
                      >
                        <Image src={image2} alt="Image 02" fill />
                      </a>
                    </div>
                  </div>
                </div>
            ...
            <Swiper {...mGalleryCarousel} className="swiper-container">
              <div className="swiper-wrapper">
                <SwiperSlide className="swiper-slide">
                  <Image src={image3} alt="Image 03" fill />
                </SwiperSlide>
                <SwiperSlide className="swiper-slide">
                  <Image src={image4} alt="Image 04" fill />
                </SwiperSlide>
                <SwiperSlide className="swiper-slide">
                  <Image src={image5} alt="Image 05" fill />
                </SwiperSlide>
              </div>
            </Swiper>
          </div>
